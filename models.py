...
class ImageTransformNet(Module):
    def __init__(self):
        ...
        self.c2=torch.nn.Conv2d(32, 64, kernel_size=3, stride=2, padding=1)
        self.c3=torch.nn.Conv2d(64, 128, kernel_size=3, stride=2, padding=1)
        ...
        self.d1=torch.nn.ConvTranspose2d(128, 64, kernel_size=3, stride=2, padding=1)
        self.d2=torch.nn.ConvTranspose2d(64, 32, kernel_size=3, stride=2, padding=1)
